...
- `.codex-scratch/review-task.md` — the authoritative per-run task and scope statement. Read it FIRST alongside `review-priority.md`: it names whether `diff.patch` is the full PR or an increment, and which memory surfaces to use for carry-forward and decline arbitration.
