...
- `.codex-scratch/author-intent.md` — the PR's title and description, i.e. the author's own statement of what this change is for. Staged with linked issues reduced to bare `owner/repo#num` + URL, so everything in this file is already public on the PR.
