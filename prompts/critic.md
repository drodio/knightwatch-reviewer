...
- `.codex-scratch/author-intent.md` — the PR's own title + description, plus linked issues as bare `owner/repo#num`. All of it is already public on the PR, so it is quotable.
